...
## To-Do List
- GetAnimalsAndEnclosuresByUserId and Handler

- Link Animal/Enclosure/User

- CreateEnclosureWithAnimalsWithUserId and Handler
- GetAnimalsByEnclosureId and Handler
- GetEnclosuresByAnimalId and Handler
