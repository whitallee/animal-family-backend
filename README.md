...
- change store function that take user ID to instead have the handlers perform ownership checks
    - create functions will have a different payload type for user and admins
